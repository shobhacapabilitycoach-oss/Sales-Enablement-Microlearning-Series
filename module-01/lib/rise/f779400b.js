...
`,uf=d`
  ...
  &[data-color=neutral] {
    ${wc}: var(--arc-color-fg-neutral-mid);
  }

  &[data-color=white] {
    ${wc}: var(--arc-color-alpha-white-90);
  }
`,hf=d`
@layer arc-components {
  ...
  [arc-spinner] {
    ...
    color: var(--arc-spinner-color, var(${wc}));
...
`,qu=(0,s.forwardRef)(({children:r,popover:e=De.popover,anchorAt:a=De.anchorAt,anchorName:t,anchorProps:o,alternateAnchorId:n,alternateAnchor:c,boundary:l=De.boundary,tryFallbacks:u=De.tryFallbacks,fallbackAnchors:h=De.fallbackAnchors,density:p=De.density,variant:v=De.variant,scheme:g=De.scheme,isInverse:f,hasTail:b,tailSize:$=De.tailSize,offset:x=De.offset,hidePopoverButton:A,headerSlot:y,showHeaderDivider:w,isHeaderSticky:k,showDismiss:E,dismissProps:_,showGoBack:I,goBackProps:C,headerSlotEnd:S,footerSlot:T,isFooterSticky:D,showFooterDivider:N,tag:H="div",contentTag:J="div",onToggle:R,...M},P)=>{const F=(0,s.useRef)(null),or=(0,s.useRef)(null),gr=(0,s.useRef)(null),L=(0,s.useRef)(R);(0,s.useImperativeHandle)(P,()=>or.current);const[X,sr]=(0,s.useState)(!1),mr=(0,s.useMemo)(()=>g==="auto"?void 0:f?"inverse":g,[f,g]),rr=(0,s.useCallback)(()=>{if(typeof document>"u")return F.current??null;const W=Sa(F.current??or.current)??document;return n?W.getElementById(n):typeof c=="string"?W.getElementById(c):c instanceof HTMLElement?c:typeof c=="function"?c():c&&typeof c=="object"&&"current"in c?c.current:F.current??null},[c,n]),ur=u||l==="flip",yr=ur?_u(h):[],lr=yr.length?yr.map(Tu).join(", "):"flip-block, flip-inline, flip-block flip-inline",kr=!!b&&!Eu.includes(a),V=Iu({canHaveTail:kr,tailSize:$}),K=(0,s.useMemo)(()=>{const W=t||n||(typeof c=="string"?c:void 0)||o?.id||M.id||void 0;return $s(String(W))},[t,o?.id,M.id,c,n]),er=(0,s.useMemo)(()=>({popoverTarget:M.id,"aria-haspopup":!0,"aria-controls":M.id,"aria-expanded":X}),[M.id,X]),O=(0,s.useMemo)(()=>({isOpen:X,"aria-label":"Dismiss",...er,..._}),[_,X,er]),cr=(0,s.useMemo)(()=>({ref:F,...er,...o,tooltip:X?void 0:o?.tooltip,anchorName:K||""}),[o,er,K,X]),br=(0,s.useMemo)(()=>({"--js\u2022anchor":cr?.anchorName||"","--js\u2022offset":Number(x)===0?"":`${x}px`,"--js\u2022tail":V.cssTailVar,"--js\u2022fallbacks":lr}),[cr?.anchorName,x,V.cssTailVar,lr]);ha(()=>{const W=rr();if(gr.current=W,!!W)return Ru(W,cr.anchorName)},[rr,cr.anchorName,X]),(0,s.useEffect)(()=>{L.current=R},[R]),(0,s.useEffect)(()=>{const W=or.current;if(!W)return;const Y=wr=>{const{newState:ir}=wr,dr=ir==="open";sr(dr),dr&&(gr.current=rr()),L.current?.(wr)};return W.addEventListener("toggle",Y),()=>W.removeEventListener("toggle",Y)},[rr]),of({anchorEl:gr.current,popoverEl:or.current,anchorAt:a,tryFallbacks:ur,fallbackAnchors:yr,offsetPx:Number(x)||0,tailSizePx:V.floatingTailPx,hasTail:kr,isOpen:X}),lf({anchorEl:gr.current,popoverEl:or.current,anchorAt:a,tryFallbacks:ur,fallbackAnchors:yr,hasTail:kr,isOpen:X});const $r=!!(y||I||S),U=!!T;return(0,i.jsxs)(i.Fragment,{children:[!((n||c)&&A)&&(0,i.jsx)(an,{...cr}),(0,i.jsxs)(H,{...M,ref:or,"arc-popover":"","arc-scheme":mr,"anchor-at":a,"is-floating":zu?"":void 0,"try-fallbacks":ur?"":void 0,popover:e,variant:v,density:p,"has-tail":kr?"":void 0,role:M.role??"dialog",style:{...M.style,...br},children:[(0,i.jsxs)(J,{"arc-popover-content":"",children:[$r&&(0,i.jsx)(em,{showDivider:w,showGoBack:I,goBackProps:C,headerSlotEnd:S,showDismiss:E,dismissProps:O,isSticky:k,children:y}),$r||U?(0,i.jsx)(am,{children:r}):(0,i.jsx)(J,{"arc-popover-display":"",children:r}),U&&(0,i.jsx)(tm,{showDivider:N,isSticky:D,children:T})]}),E&&!$r&&(0,i.jsx)(Wu,{...O})]})]})});qu.displayName="ArcPopover";const js=qu;js.handlePopover=Pu,js.Button=an;const ga=js;Cr("ArcPopover",gm);const oo=d`--arc•icon•text`,cn=d`${oo}•font•size`,Yu=d`${oo}•icon`,Ls=d`${oo}•text`,Zu=d`${oo}•subtext`,va=d`${oo}•fg`,Wa=d`${oo}•gap`,st=d`${Yu}•size`,Ju=d`${Yu}•vertical•align`,sn=d`${Ls}•overflow`,Lc=d`${Ls}•text•overflow`,Mc=d`${Ls}•white•space`,Dc=d`${Zu}•font•size`,Qu=d`${Zu}•fg`,vm=d`
...
@layer arc-components {
  ...
  [arc-card] {
    ...
    > * {
      font-size: var(--arc-card-font-size, var(${kn}));
    }
...
`,v1=(r,e)=>[{test:()=>e&&!r,value:`repeat(auto-fill, minmax(${e}, 1fr))`},{test:()=>e&&bc(r)&&r>0,value:`repeat(${r}, minmax(${e}, min-content))`},{test:()=>bc(r)&&r>0&&!e,value:`repeat(${r}, minmax(0, 1fr))`},{test:()=>At(r)&&(!e||e==="0em"),value:r},{test:()=>!0,value:void 0}],f1=(r,e)=>v1(r,e).find(a=>a.test())?.value,Gh=r=>{if(!r)return[void 0,void 0];const[e,a]=r.trim().split(/\s+/);return[e,a??e]},m1=({mode:r,gap:e,minItemWidth:a,columns:t,canWrap:o,alignItems:n,justifyItems:c,alignContent:l,justifyContent:u,placeItems:h,placeContent:p,tag:v="div",style:g,...f})=>{const b=r==="grid"?f1(t,a):void 0,$=r==="row"&&!!a,x=bc(e)&&e>0,[A,y]=Gh(h),[w,k]=Gh(p),E={"--js\u2022align":n??A,"--js\u2022justify":u??k,"--js\u2022justify\u2022items":c??y,"--js\u2022align\u2022content":l??w},_={...g,...b?{"--js\u2022cols":b}:{},...x?{"--js\u2022gap":`max(${e}px, ${e} / 16 * 1em)`}:{},...$?{"--js\u2022miw":a}:{},...Object.fromEntries(Object.entries(E).filter(([,I])=>I!=null))};return(0,i.jsx)(v,{...f,"arc-layout":r,"data-gap":x?"number":e??void 0,"can-wrap":o?"":void 0,style:_})};Cr("ArcLayout",g1);const b1=r=>r===!0?"multiple":r==="single"||r==="multiple"?r:void 0,$1=({mode:r="grid",gap:e="md",role:a,isSelectable:t,onSelectionChange:o,activateOnFirstSelect:n=!1,...c})=>{const l=b1(t),u=(0,s.useRef)({mode:"multiple",activateOnFirstSelect:n,onSelectionChange:o});u.current={mode:l??"multiple",activateOnFirstSelect:n,onSelectionChange:o};const h=(0,s.useRef)(null);l&&!h.current?h.current=Dh(()=>u.current):!l&&h.current&&(h.current=null);const p=h.current,v=(0,s.useSyncExternalStore)(p?.subscribe??(()=>()=>{}),()=>p?.isActive()??!1,()=>!1),g=(0,i.jsx)(m1,{...c,"arc-card-layout":"",...v?{"is-selectable":""}:{},mode:r,gap:e,role:a??(r==="row"?"group":void 0)});return p?(0,i.jsx)($n.Provider,{value:p,children:g}):g},vo=()=>{},Tt=d`--arc•cb`,Ie=d`${Tt}•o`,bl=d`${Ie}•icon`,$l=d`${Ie}•text`,Kh=d`${Tt}•fs`,Wh=d`${Tt}•br`,yl=d`${Tt}•di`,Xh=d`${Tt}•pd`,qh=d`${Tt}•gp`,Yh=d`${Tt}•bg`,wn=d`${Ie}•fg`,ei=d`${Ie}•bg`,Zh=d`${Ie}•bc`,xl=d`${Ie}•bw`,ai=d`${Ie}•br`,Jh=d`${Ie}•fw`,Qh=d`${Ie}•ol`,rp=d`${Ie}•ow`,ep=d`${Ie}•oo`,ap=d`${Ie}•lh`,ti={BAR:d`
  ...
  `,SOLID_OPTION_STATES:d`
    &:not(:has(:disabled, :checked)) {
      &:hover {
        ${wn}: var(--arc-color-fg-on-hover-default);
...
`,jy=({orientation:r,isFlipped:e,isDisabled:a,density:t,hierarchy:o,showIcons:n,showLabels:c,missingIcon:l,items:u,canRollUp:h,maxVisible:p,rollUpLabel:v,listRole:g,selectedAttr:f,selectedValue:b,elementProps:$})=>{const x=Nr(void 0,"arc-button-bar-trigger"),A=`${x}-menu`,y=r==="vertical",w=h&&!y,k=t??(y?"comfortable":"compact"),E=u.findIndex(L=>L.isSelected),_={showIcons:n,showLabels:c,missingIcon:l,isVertical:y},I=(0,s.useMemo)(()=>`${u.map(X=>{const sr=typeof X.icon=="string"?X.icon:X.icon?"":"";return`${X.text}${X.href??""}${sr}${X.isDisabled?1:0}`}).join("")}|${k}|${o??""}|${E}|${n?1:0}|${c?1:0}`,[u,k,o,E,n,c]),{barRef:C,visibleCount:S,hasOverflow:T,isMeasuring:D}=Cy({enabled:w,itemCount:u.length,signature:I,selectedIndex:E,maxVisible:p}),N=D?u:u.slice(0,S),H=D?[]:u.slice(S),J=w&&(D||T),R=E>=0?u[E]:void 0,M=!D&&R!=null&&H.includes(R),P=Qp(M?R.icon:yy,M?R.text:v,M?R.tooltip:void 0,_),F=M?R.firstSlot:void 0,or=M?R.lastSlot:void 0,gr=Jp(f,b);return(0,i.jsxs)("ul",{...$,ref:C,"arc-button-bar":r,role:g,"data-density":k,"data-measuring":D?"":void 0,"data-rollup":w?"":void 0,"is-flipped":e?"":void 0,"is-managed":"",children:[N.map((L,X)=>{const{isSelected:sr,isDisabled:mr,tag:rr,icon:ur,text:yr,tooltip:lr,firstSlot:kr,lastSlot:V,isHidden:K,onClick:er,...O}=L,cr=Qp(ur,yr,lr,_),br=a||mr;return(0,s.createElement)("li",{...Sy,key:_y(L,X),"arc-button-bar-item":sr?"selected":""},(0,i.jsxs)(Lr,{...O,tag:rr,layout:y?"fill":"hug",size:"inherit",variant:"neutral",hierarchy:"tertiary",shape:"square",tooltip:cr.tooltip,"aria-label":cr.ariaLabel,"is-selected":sr?"":void 0,isDisabled:br||void 0,onClick:br?Ey:er,...sr?{[f]:gr}:{},children:[(0,i.jsx)(le,{icon:y?wu(cr.icon):cr.icon,"arc-icon-status":cr.iconStatus,text:cr.text,overflow:"truncate",gapSize:"md",iconSize:k==="comfortable"?"md":void 0}),c&&(0,i.jsx)(Fl,{firstSlot:kr,lastSlot:V,isVertical:y})]}))}),J?(0,i.jsxs)("li",{...zy,"arc-button-bar-item":M?"selected":"",children:[(0,i.jsxs)(Lr,{id:x,"arc-button-bar-rollup":"trigger","is-selected":M?"":void 0,layout:y?"fill":"hug",shape:"square",size:"inherit",variant:"neutral",hierarchy:"tertiary",isDisabled:a||void 0,tooltip:P.tooltip,"aria-label":P.ariaLabel,iconEnd:xy,popoverTarget:A,popoverTargetAction:"toggle","aria-haspopup":"menu","aria-controls":A,children:[(0,i.jsx)(le,{icon:P.icon,text:P.text,"arc-icon-status":P.iconStatus,overflow:"truncate",gapSize:"md"}),c&&(0,i.jsx)(Fl,{firstSlot:F,lastSlot:or,isVertical:y})]}),H.length>0&&(0,i.jsx)(ho,{id:A,alternateAnchorId:x,"arc-button-bar-rollup":"menu",anchorAt:"bottom-end",hidePopoverButton:!0,items:H.map(L=>Ty(L,{selectedAttr:f,selectedValue:b,isVertical:y,isBarDisabled:a,showIcons:n}))})]}):null]})},jt=({children:r,...e})=>{const{tag:a,orientation:t="horizontal",isFlipped:o=!1,isDisabled:n=!1,items:c,canRollUp:l=!1,maxVisible:u,rollUpLabel:h="More",density:p,hierarchy:v,showIcons:g=!0,showLabels:f=!0,missingIcon:b=ky,listRole:$="list",selectedAttr:x="aria-current",selectedValue:A,...y}=e;if(c){const k=c.filter(E=>!E.isHidden);return(0,i.jsx)(jy,{orientation:t,isFlipped:o,isDisabled:n,density:p,hierarchy:v,showIcons:g,showLabels:f,missingIcon:b,items:k,canRollUp:l,maxVisible:u,rollUpLabel:h,listRole:$,selectedAttr:x,selectedValue:A,elementProps:y})}const w=a??"menu";return(0,i.jsx)(w,{...y,"arc-button-bar":t,"is-flipped":o?"":void 0,role:y.role??"group",children:r})};Cr("ArcButtonBar",Ry);function jn(r){const e=(0,s.useRef)(r);e.current=r;const a=(0,s.useCallback)((...t)=>e.current?.(...t),[]);return r?a:void 0}const Ly=({activeColor:r})=>{const[e,a]=(0,s.useState)(r),t=r!=null,o=t?r:e;(0,s.useEffect)(()=>{a(r)},[r]);const n=(0,s.useCallback)(c=>{t||a(c)},[t]);return{isSelectionControlled:t,activeSelectedColor:o,setUncontrolledSelectedColor:a,selectColor:n}},My=({palette:r,isSelectionControlled:e,onAddColor:a,emitColorChange:t,setLocalColors:o,setUncontrolledSelectedColor:n,initialColorValue:c,shouldOpenPopover:l=!0,notifyAddColorToggle:u,showPopover:h,hidePopover:p})=>{const v=(0,s.useCallback)(()=>c??Tn(),[c]),[g,f]=(0,s.useState)(null),[b,$]=(0,s.useState)(v),x=(0,s.useCallback)(()=>{f(null),$(v())},[v]),A=(0,s.useCallback)(S=>{o(T=>oe(S)?T.some(H=>oe(H)&&ht(H,S))?T:[...T,S]:T.some(N=>!oe(N)&&xo(N,S))?T:[...T,S])},[o]),y=(0,s.useCallback)((S,T)=>{a?.(r,S,T),oe(S)||(t(S),e||n(S))},[t,e,a,r,n]),w=(0,s.useCallback)((S,T)=>{A(S),y(S,T??void 0)},[A,y]),k=(0,s.useCallback)(()=>{if(g!=null)return;const S=v();let T=-1;o(D=>(T=D.length,[...D,S])),f(T),$(S),u?.(!0),l&&h()},[g,v,u,o,l,h]),E=(0,s.useCallback)(S=>{g!=null&&$(S)},[g]),_=(0,s.useCallback)(S=>{S?.preventDefault(),S?.stopPropagation(),g!=null&&o(T=>T.filter((D,N)=>N!==g)),x(),u?.(!1),l&&p()},[g,p,u,x,o,l]),I=(0,s.useCallback)((S,T)=>{const N=(R=>typeof R?.preventDefault=="function")(S)?S:T;if(N?.preventDefault(),N?.stopPropagation(),g==null||b==null){u?.(!1),l&&p();return}const J=(r.colors??[]).map((R,M)=>M===g?b:R);o(J),y(b,N??void 0),x(),u?.(!1),l&&p()},[g,b,y,p,u,r.colors,x,o,l]),C=(0,s.useCallback)((S,T)=>{T?.preventDefault(),T?.stopPropagation(),w(S,T??void 0)},[w]);return{draftColorIndex:g,draftColorValue:b,startAddDraft:k,updateDraftColor:E,cancelDraftColor:_,saveDraftColor:I,saveCurrentColor:C}};let r0=!1;const Ln=new Set,Gl=r=>{r0=r,Ln.forEach(e=>{e.setState(r),r||e.onRelease?.()})},e0=r=>{(r.metaKey||r.key==="Meta")&&Gl(!0)},a0=r=>{Gl(!!r.metaKey)},t0=()=>{Gl(!1)},Dy=r=>{const[e,a]=(0,s.useState)(r0),t=(0,s.useRef)(r);return t.current=r,(0,s.useEffect)(()=>{const o={setState:a,onRelease:()=>t.current?.()};return Ln.add(o),Ln.size===1&&(window.addEventListener("keydown",e0),window.addEventListener("keyup",a0),window.addEventListener("blur",t0)),a(e),()=>{Ln.delete(o),Ln.size===0&&(window.removeEventListener("keydown",e0),window.removeEventListener("keyup",a0),window.removeEventListener("blur",t0))}},[]),e},Be=d`--arc-popover`,Co=d`--arc•color•picker`,ne=d`${Co}•thumb`,Lt=d`${Co}•tools`,ja=d`${Co}•dropper`,o0=d`--js•hex`,Kl=d`
  background-image:
    linear-gradient(
      to right,
      transparent,
...
`,c0=(0,s.memo)(({color:r,gradient:e,name:a,kind:t,isDraft:o,isSelected:n,contrastBias:c,contrastBgColor:l,canRemoveColor:u,icon:h,text:p,tooltip:v,labels:g,onClick:f,style:b,popoverTargetAction:$,...x})=>{const A=(0,s.useMemo)(()=>ui(g),[g]),{cssColor:y,isTranslucent:w,isTransparent:k,opaqueHex:E}=(0,s.useMemo)(()=>Cp(r??""),[r]),_=e?Op(e,a):$o(r??"",a),I=p??_??(e?A.gradient:y),C=xp(y)?y.toUpperCase():y,S=v??_??(e?A.gradient:C),T=(0,s.useMemo)(()=>e?yi(e,y):y,[e,y]),D=(0,s.useRef)(null),[N,H]=(0,s.useState)(null),J=!e&&!k&&y!==""&&y!=="transparent"&&!Zr(y),R=(0,s.useCallback)(()=>{const Y=D.current;H(J&&Y&&typeof window<"u"?_p(Y):null)},[J]);(0,s.useEffect)(()=>{R()},[R]);const M=e?T:N??y,P=(0,s.useMemo)(()=>ko(M,{contrastBias:c,bgColor:l}),[M,c,l]),[F,or]=(0,s.useState)(!1),[gr,L]=(0,s.useState)(!1),[X,sr]=(0,s.useState)(!1),[mr,rr]=(0,s.useState)(!1),ur=Dy(()=>L(!1)),lr=(t==="swatch"||t==="gradient")&&!!u&&(X&&ur||(ur||gr)&&F),kr=lr||mr,V=kr?"fa-regular fa-xmark":h??"fa-solid fa-check",K=t==="gradient"?A.removeGradient:A.removeColor,er=kr?K:S;(0,s.useEffect)(()=>{lr&&rr(!0)},[lr]),(0,s.useEffect)(()=>{!lr&&n&&!o&&rr(!1)},[o,lr,n]);const O=(0,s.useCallback)(Y=>{const wr=lr||Y.metaKey?"remove":"select",ir={...Ra(y,{format:"auto",fallbackHex:y,contrastBias:c,contrastBgColor:l}),contrastColor:P,name:_};if(t==="gradient"&&e!=null){f?.({kind:t,colorData:ir,gradientData:wo(e,{contrastBias:c,contrastBgColor:l}),action:wr,shouldClosePicker:!1},Y);return}f?.({kind:t,colorData:ir,action:wr,shouldClosePicker:!1},Y)},[lr,f,y,_,t,e,c,l,P]),cr=(0,s.useCallback)(Y=>{$||Y.preventDefault(),Y.stopPropagation(),O(Y)},[O,$]),br=(0,s.useCallback)(Y=>{Y.metaKey&&(Y.preventDefault(),Y.stopPropagation(),O(Y))},[O]),$r=(0,s.useCallback)(Y=>{const wr=Y.propertyName??"";(wr==="color"||wr.includes("color"))&&(R(),!lr&&rr(!1))},[lr,R]),U=(0,s.useCallback)(Y=>{Y.key!=="Enter"||!lr||(Y.preventDefault(),Y.stopPropagation(),Y.currentTarget.click())},[lr]),W=(0,s.useMemo)(()=>({...b??{},"--js\u2022hex":k?"transparent":w&&(E??y??T)||"","--js\u2022color":y??T,"--js\u2022gradient":e?Za(e):"","--js\u2022fg":n&&!o||lr?P:""}),[b,k,w,E,y,T,n,o,lr,P,e]);return(0,i.jsx)(Lr,{...x,popoverTargetAction:$,ref:D,_isCustom:!0,"arc-color-chip":t,layout:"icon",tooltip:er,text:I,icon:V,"is-draft":o?"":void 0,"is-selected":!o&&n?"":void 0,"is-translucent":w?"":void 0,"is-transparent":k?"":void 0,style:W,onClick:cr,onContextMenu:br,onMouseEnter:Y=>{or(!0),L(Y.metaKey)},onMouseMove:Y=>{L(Y.metaKey)},onMouseLeave:()=>{or(!1),L(!1),rr(!1)},onFocus:()=>sr(!0),onBlur:()=>{sr(!1),rr(!1)},onKeyDown:U,onTransitionEnd:$r})});c0.displayName="ArcColorSwatch";const Mn=c0;Mn.getColorData=Ra,Cr("ArcColorSwatch",Gy);const Ky=d`
@layer arc-components {
...
[arc-input] {
  ...
  & {
    ...
    ${Jr}•outline: var(${x0}) solid var(${w0}, transparent);
  }
}
...
[arc-input]:not([hidden]) {
  ...
  [input-element=body] {
    ...
    outline-offset: var(--arc-input-outline-offset, var(${k0}));
...
`,Yx=vr(sa,["hug","fill"]),Zx=Ho,Jx=vr(Xr,["common","solid"]),Qx=Vo,xd=({children:r,label:e,icon:a,name:t,value:o,...n})=>{const c=r||(0,i.jsx)(le,{icon:a,text:e});return(0,i.jsx)("li",{"arc-radio-bar-option":"","data-is-checked":n?.checked||void 0,children:(0,i.jsx)(H0,{...n,name:t,value:o,label:c,layout:"fill",useMask:!1,onChange:n.onChange??vo})})},X0=({children:r,density:e,size:a,layout:t="hug",variant:o="common",name:n,options:c,value:l,isDisabled:u,onChange:h,...p})=>{const v=Nr(n,"arc-radio-bar"),g=e??Kt(a)??"comfortable";return(0,i.jsx)("ul",{...p,"arc-radio-bar":"","data-density":g,"data-size":nt(g),"data-layout":t,"data-variant":o,"is-disabled":u?"":void 0,role:"radiogroup",children:c?c.map(({hidden:f,onChange:b,value:$,...x})=>f||$==null||$===""?null:(0,s.createElement)(xd,{...x,key:String($),name:v,value:$,checked:l===$,disabled:u||x.disabled,onChange:b??h??vo})):r})};Cr("ArcRadioBar",qx);const rk=(r,e)=>r==="gradient"?e.panelGradient:e.panelSolid,ek=({canTogglePanels:r,panels:e,activePanel:a,setActivePanel:t,labels:o=pe})=>(0,i.jsx)(i.Fragment,{children:r&&(0,i.jsx)("div",{"arc-color-picker-section":"control",children:(0,i.jsx)(X0,{layout:"fill",size:"md",children:e.map(n=>(0,i.jsx)(xd,{name:"color-picker-panel",value:n,label:rk(n,o),checked:n===a,onChange:()=>t(n)},n))})})}),{STOP_MIN:kd,STOP_MAX:wd}=nr,ak=(0,s.memo)(function({stop:e,stopIndex:a,sortedIndex:t,value:o,isEditing:n,isEditingColor:c,isAnyColorEditing:l,labels:u,onFocus:h,onInput:p,onCommit:v,onRevert:g,onOpenColorEdit:f,onRegisterAnchor:b,onInsertStopAt:$,onDelete:x}){const A=u??pe,y=t+1,w=Nr(void 0,"gradient-stop-row-anchor"),k=Nr(void 0,"gradient-stop-input"),E=(0,s.useRef)(null),_=(0,s.useRef)(t),I=O0({min:kd,max:wd,getValue:()=>Number(o),onStep:H=>{const J=String(H);p(J),v(J,!1)}}),C=(0,s.useCallback)(H=>{if(H.key==="Enter"){H.preventDefault(),v(void 0,!0),H.currentTarget.blur();return}H.key==="Escape"&&(H.preventDefault(),g(),H.currentTarget.blur())},[v,g]),S=P0(I,C),T=(0,s.useCallback)(()=>v(void 0,!0),[v]),D=(0,s.useCallback)(({value:H})=>p(String(H??o)),[p,o]);(0,s.useLayoutEffect)(()=>{if(!n){_.current=t;return}if(_.current===t)return;_.current=t;const H=E.current;if(!H)return;const{selectionStart:J,selectionEnd:R}=H;H.focus({preventScroll:!0}),J!=null&&R!=null&&H.setSelectionRange(J,R)},[n,t]),(0,s.useLayoutEffect)(()=>{b?.(a,w)},[b,w,a]);const N=n?o:String(ar(e.at,kd,wd));return(0,i.jsxs)("li",{"arc-gradient-stop-row":"",id:w,"is-editing-color":c?"":void 0,children:[t>0&&(0,i.jsx)("span",{"arc-gradient-stop-insert":"",children:(0,i.jsx)(Lr,{_isCustom:!0,icon:"fa-solid fa-plus fa-2xs",onClick:()=>$(t),tooltip:A.insertColorStop,isDisabled:l})}),(0,i.jsx)(Mn,{kind:"gradient-stop",color:e.color,onClick:()=>f(a,w)}),(0,i.jsx)(zo,{ref:E,"arc-color-input":"stop",inputProps:{type:"number",appearance:"textfield",id:k,"aria-label":A.stopPosition(y),value:N,min:kd,max:wd,step:1,onFocus:h,onBlur:T,onKeyDown:S,onChange:D,wheelControl:{deltaPerStep:24}},size:"md",variant:"solid",inputSuffix:"%"}),(0,i.jsx)("span",{"row-spacer":""}),(0,i.jsx)(Lr,{layout:"icon",size:"sm",icon:"fa-regular fa-trash",variant:"tertiary",tooltip:A.removeColorStop,onClick:()=>x(a),isDisabled:l})]})}),q0=({children:r,sectionName:e,content:a,...t})=>(0,i.jsxs)("header",{"arc-color-section-header":e??"",...t,children:[(0,i.jsx)(le,{...typeof a=="object"?a:{text:a},size:"sm",isStrong:!0}),r]}),{STOP_MIN:Ad,STOP_MAX:Cd}=nr,tk=r=>({kind:"stop-at",stopId:r}),ok=({state:r,isEmpty:e=!1,onAddGradient:a,editFallbackColor:t="#000000",format:o=Je.format,labels:n})=>{const c=n??pe,{interaction:l,commitGradient:u,commitUnset:h,previewGradient:p,editFocus:v,editInput:g,editBlur:f}=r,b=r.displayGradient,$=(0,s.useMemo)(()=>b.stops??[],[b.stops]),x=(0,s.useMemo)(()=>ya($),[$]),[A,y]=(0,s.useState)([]),w=(0,s.useRef)(0),k=(0,s.useCallback)(()=>(w.current+=1,`gradient-stop-${w.current}`),[]),E=Nr(void 0,"gradient-stop-edit-popover"),[_,I]=(0,s.useState)(null),C=(0,s.useRef)(null),[S,T]=(0,s.useState)(),[D,N]=(0,s.useState)(t),[H,J]=(0,s.useState)(!1),[R,M]=(0,s.useState)(!1),[P,F]=(0,s.useState)(),[or,gr]=(0,s.useState)(0),L=(0,s.useRef)(!1),X=(0,s.useRef)(null),sr=(0,s.useCallback)(()=>ga.handlePopover?.(E,"show"),[E]),mr=(0,s.useCallback)(()=>ga.handlePopover?.(E,"hide"),[E]);(0,s.useEffect)(()=>{y(q=>q.length===$.length?q:q.length<$.length?[...q,...Array.from({length:$.length-q.length},()=>k())]:q.slice(0,$.length))},[k,$.length]);const rr=(0,s.useCallback)(q=>u({...b,stops:q}),[u,b]),ur=(0,s.useCallback)(q=>{const pr=ya(q);y(Rr=>pr.map(Ir=>Rr[Ir.index]??k())),rr(pr.map(Rr=>Rr.stop))},[k,rr]),yr=(0,s.useCallback)(q=>l.status==="editingText"&&l.field.kind==="stop-at"&&l.field.stopId===q?l.draft:void 0,[l]),lr=(0,s.useCallback)((q,pr,Rr,Ir,Sr,Gr)=>{const Fr=$[q];if(!Fr){f();return}const Hr=Rr??yr(pr)??String(Fr.at),Ve=Number(Hr);if(Number.isNaN(Ve)){f();return}const ee=ar(Ve,Ad,Cd),we=Ir||Ol(Sr,Gr,ee),Qe={...Fr,at:ee},at=$.map((ra,Do)=>Do===q?Qe:ra);ee!==Fr.at?we?ur(at):rr(at):we&&ur($),f()},[$,yr,f,ur,rr]),kr=(0,s.useCallback)((q,pr)=>{const Rr=$[q],Ir=Number(pr);if(!Rr||Number.isNaN(Ir))return;const Sr=ar(Ir,Ad,Cd),Gr=$.map((Fr,Hr)=>Hr===q?{...Fr,at:Sr}:Fr);p({...b,stops:Gr})},[$,b,p]),V=(0,s.useCallback)((q={kind:"append"})=>{const pr=$.length,Rr=q.kind==="append"?Dp($):[...$,Mp($,q)];X.current=pr,y(Ir=>[...Ir,k()]),rr(Rr)},[k,$,rr]),K=(0,s.useCallback)(q=>{C.current===q&&(mr(),C.current=null,I(null),J(!1));const pr=$.filter((Rr,Ir)=>Ir!==q);if(y(Rr=>Rr.filter((Ir,Sr)=>Sr!==q)),pr.length===0){h();return}rr(pr)},[h,$,mr,rr]),er=(0,s.useCallback)(()=>{$.length<2||ur(jp($))},[ur,$]),O=(0,s.useCallback)(q=>V({kind:"between",sortedIndex:q}),[V]),cr=(0,s.useCallback)((q,pr,Rr)=>{if(!$[q])return;const Sr=$.map((Gr,Fr)=>Fr===q?{...Gr,color:pr}:Gr);Rr==="preview"?p({...b,stops:Sr}):rr(Sr)},[$,b,p,rr]),br=(0,s.useCallback)(()=>{mr(),C.current=null,I(null),J(!1)},[mr]),$r=(0,s.useCallback)((q,pr)=>{const Rr=$[q];if(!Rr)return;const Ir=C.current!=null;C.current=q,M(!0),I(q),T(pr),N(Rr.color),Ir?gr(Sr=>Sr+1):(L.current=!0,F(pr))},[$]),U=(0,s.useCallback)((q,pr)=>{if(C.current===q){br();return}$r(q,pr)},[br,$r]),W=(0,s.useCallback)((q,pr)=>{X.current!==q||!$[q]||(X.current=null,$r(q,pr))},[$,$r]);(0,s.useEffect)(()=>{!L.current||_==null||!S||(L.current=!1,sr())},[S,_,sr]);const Y=(0,s.useCallback)(q=>{const pr=q?.newState==="open";J(pr),pr||(C.current=null,I(null))},[]),wr=(0,s.useCallback)(q=>{q.key!=="Escape"||!H||br()},[br,H]),ir=(0,s.useCallback)(q=>{N(q);const pr=C.current;pr!=null&&cr(pr,q,"commit")},[cr]),dr=(0,s.useCallback)(q=>{cp(q)&&ir(q.color.value)},[ir]);return e||$.length===0?(0,i.jsx)("div",{"arc-gradient-stops":"",children:(0,i.jsx)(Lr,{"arc-gradient-add":"",icon:"fa-regular fa-plus",text:c.addGradient,variant:"neutral",hierarchy:"tertiary",size:"sm",onClick:a})}):(0,i.jsxs)("div",{"arc-gradient-stops":"",children:[(0,i.jsx)(q0,{content:c.gradientStops,sectionName:"stops",children:(0,i.jsxs)(jt,{children:[(0,i.jsx)(Lr,{"arc-gradient-stop-distribute":"",layout:"icon",size:"sm",icon:"fa-regular fa-arrows-left-right-to-line",variant:"tertiary",onClick:er,tooltip:c.distributeColorStops,isDisabled:$.length<2}),(0,i.jsx)(Lr,{"arc-gradient-stop-add":"",layout:"icon",size:"sm",icon:"fa-regular fa-plus",variant:"tertiary",onClick:()=>V({kind:"append"}),tooltip:c.addColorStop,isDisabled:_!=null})]})}),(0,i.jsx)("ul",{"arc-gradient-stop-list":"",children:x.map((q,pr)=>{const Rr=A[q.index]??`gradient-stop-row-${q.index}`,Ir=tk(Rr),Sr=String(ar(q.stop.at,Ad,Cd)),Gr=x[pr-1]?.stop.at,Fr=x[pr+1]?.stop.at;return(0,i.jsx)(ak,{stop:q.stop,stopIndex:q.index,sortedIndex:pr,value:Xl(Ir,Sr,l),isEditing:qy(l,Ir),isEditingColor:_===q.index,isAnyColorEditing:_!=null,onFocus:()=>v(Ir,Sr),onInput:Hr=>{g(Hr),kr(q.index,Hr)},onCommit:(Hr,Ve=!1)=>lr(q.index,Rr,Hr,Ve,Gr,Fr),onRevert:f,onOpenColorEdit:U,onRegisterAnchor:W,onInsertStopAt:O,onDelete:K,labels:n},Rr)})}),R&&(0,i.jsx)(La,{mode:"edit",heading:"",panels:["solid"],color:D,syncKey:or,format:o,labels:n,onPreviewColor:q=>{const pr=C.current;pr!=null&&cr(pr,q.value,"preview")},onChange:dr,popoverProps:{id:E,popover:"manual",anchorAt:"left-center",alternateAnchorId:S,hidePopoverButton:!0,tryFallbacks:!0,hasTail:!0,offset:12,onToggle:Y,onKeyDown:wr,footerSlot:(0,i.jsxs)(jt,{"arc-color-picker-button-bar":"",children:[(0,i.jsx)("span",{"arc-button-bar-spacer":""}),(0,i.jsx)(Lr,{"arc-color-picker-button":"save",text:c.done,size:"sm",onClick:br})]})}},P)]})},Y0=r=>{const e=(0,s.useRef)(null),a=(0,s.useRef)(null),t=(0,s.useRef)(r);t.current=r;const o=(0,s.useCallback)(()=>{e.current=null;const h=a.current;a.current=null,h&&t.current(h.value)},[]),n=(0,s.useCallback)(h=>{a.current={value:h},e.current==null&&(e.current=requestAnimationFrame(o))},[o]),c=(0,s.useCallback)(()=>{e.current!=null&&(cancelAnimationFrame(e.current),e.current=null),a.current=null},[]),l=(0,s.useCallback)(()=>{e.current!=null&&(cancelAnimationFrame(e.current),o())},[o]),u=(0,s.useCallback)(()=>e.current!=null,[]);return(0,s.useEffect)(()=>c,[c]),{schedule:n,cancel:c,flush:l,hasPending:u}},Z0=.05,J0=.5,nk=4,ck=(0,s.memo)(function({entry:e,sortedIndex:a,angle:t,isDragging:o,stopPositionLabel:n,onAtChange:c,onDragStart:l}){const{stop:u,index:h}=e,p=ar(u.at,nr.STOP_MIN,nr.STOP_MAX),v=(0,s.useCallback)(f=>{const b=Up(f.key,t);if(b==null)return;f.preventDefault();const $=ar(p+b,nr.STOP_MIN,nr.STOP_MAX);c(h,$,!0)},[t,p,c,h]),g=(0,s.useCallback)(f=>{f.preventDefault(),f.stopPropagation(),l(h,f.pointerId)},[l,h]);return(0,i.jsx)("div",{"arc-gradient-stop-thumb":"",role:"slider",tabIndex:0,"aria-valuemin":nr.STOP_MIN,"aria-valuemax":nr.STOP_MAX,"aria-valuenow":Math.round(p),"aria-label":n(a+1),"is-dragging":o?"":void 0,style:{left:`${p}%`,background:String(u.color),zIndex:a+1},onPointerDown:g,onKeyDown:v})}),Q0=(r,e)=>{const a=r.getBoundingClientRect(),t=r.offsetWidth/2;return{centerX:a.left+a.width/2,centerY:a.top+a.height/2,axisHalfLength:t,axisAngleDeg:e-90}},ik=({stops:r,angle:e=nr.ANGLE,isUnset:a=!1,onUpdateStops:t,onUpdateAngle:o,labels:n})=>{const c=n??pe,l=(0,s.useRef)(null),u=(0,s.useRef)(null),h=(0,s.useRef)(null),p=(0,s.useRef)(null),v=(0,s.useRef)(null),g=(0,s.useRef)(null),f=(0,s.useRef)(null),b=(0,s.useRef)(null),[$,x]=(0,s.useState)(null),[A,y]=(0,s.useState)(null),[w,k]=(0,s.useState)(null),[E,_]=(0,s.useState)(!1),I=A??e,C=(0,s.useMemo)(()=>$??r??[],[$,r]),S=(0,s.useMemo)(()=>ya(C),[C]),T=(0,s.useMemo)(()=>{const U=C.length>0?C:nr.STOPS;return $?Rt(U,nr.STOP_MIN,nr.STOP_MAX):U},[$,C]),D=(0,s.useMemo)(()=>({background:a?"var(--arc-color-bg-mono)":Bp({stops:T,angle:nr.ANGLE}),rotate:`${I-90}deg`}),[T,I,a]),N=(0,s.useCallback)(U=>{t?.(U,"preview")},[t]),H=(0,s.useCallback)((U,W=!1)=>{const Y=Rt(U,nr.STOP_MIN,nr.STOP_MAX);t?.(W?Pp(Y):Y,"commit")},[t]),J=(0,s.useCallback)(U=>{o?.(U,"preview")},[o]),R=(0,s.useCallback)(U=>{o?.(U,"commit")},[o]),M=(0,s.useCallback)((U,W,Y=!1)=>{const wr=r??[],ir=wr[U];if(!ir||Math.abs(ir.at-W)<Z0)return;const dr=wr.map((q,pr)=>pr===U?{...q,at:W}:q);H(dr,Y)},[H,r]),P=(0,s.useCallback)((U,W,Y)=>{const wr=h.current,ir=l.current;if(!ir)return null;const dr=wr??Q0(ir,I);return Fp(U,W,dr.centerX,dr.centerY,dr.axisAngleDeg,dr.axisHalfLength,nr.STOP_MIN,nr.STOP_MAX,Y)},[I]),F=(0,s.useCallback)(U=>{if(!Number.isFinite(U))return;const W=Math.round(U),Y=g.current??e;Math.abs(Y-W)<J0||(g.current=W,y(W),(b.current==null||Math.abs(b.current-W)>=J0)&&(b.current=W,J(W)))},[e,J]),or=(0,s.useCallback)((U,W)=>{const Y=v.current??r??[],wr=Y[U];if(!wr||Math.abs(wr.at-W)<Z0)return;const ir=Y.map((Rr,Ir)=>Ir===U?{...Rr,at:W}:Rr);v.current=ir,x(ir);const dr=Rt(ir,nr.STOP_MIN,nr.STOP_MAX),q=f.current,pr=I;(!q||!$i({stops:q,angle:pr},{stops:dr,angle:pr}))&&(f.current=dr,N(dr))},[N,I,r]),gr=(0,s.useCallback)(U=>{const W=u.current;if(W==null)return;const Y=P(U.clientX,U.clientY,!1);Y!=null&&or(W,Y)},[or,P]),{schedule:L,cancel:X,flush:sr}=Y0(gr),mr=(0,s.useCallback)(U=>{const W=p.current;if(!W||!W.hasExceededThreshold)return;const Y=Bl(U.clientX,U.clientY,W.centerX,W.centerY),wr=Hp(W.startAngle,W.startPointerAngleDeg,Y,nr.ANGLE_MIN,nr.ANGLE_MAX);F(U.shiftKey?Vp(wr):wr)},[F]),{schedule:rr,cancel:ur,flush:yr}=Y0(mr),lr=(0,s.useCallback)((U,W)=>{const Y=l.current;Y&&(Y.setPointerCapture(W),u.current=U,h.current=Q0(Y,I),v.current=[...r??[]],f.current=Rt(v.current,nr.STOP_MIN,nr.STOP_MAX),x(v.current),k(U))},[I,r]),kr=(0,s.useCallback)((U,W)=>{if(S.length===0)return;const Y=P(U,W,!0);if(Y==null)return;const wr=S.reduce((ir,dr)=>{const q=Math.abs(dr.stop.at-Y);return!ir||q<ir.distance?{stopIndex:dr.index,distance:q}:ir},null);wr&&M(wr.stopIndex,Y,!0)},[M,P,S]),V=(0,s.useCallback)(()=>{const U=p.current;if(U?.hasExceededThreshold&&yr(),ur(),p.current=null,!!U){if(U.hasExceededThreshold){const W=g.current;W!=null&&R(W)}else kr(U.startClientX,U.startClientY);g.current=null,b.current=null,y(null),_(!1)}},[ur,R,kr,yr]),K=(0,s.useCallback)(()=>{sr(),X();const U=v.current;U&&H(U,!0),u.current=null,h.current=null,v.current=null,f.current=null,x(null),k(null)},[X,H,sr]),er=(0,s.useCallback)(U=>{if(!o){kr(U.clientX,U.clientY);return}const W=l.current;if(!W)return;const Y=W.getBoundingClientRect(),wr=Y.left+Y.width/2,ir=Y.top+Y.height/2;W.setPointerCapture(U.pointerId);const dr=Number.isFinite(U.clientX)?U.clientX:0,q=Number.isFinite(U.clientY)?U.clientY:0;p.current={pointerId:U.pointerId,startClientX:dr,startClientY:q,lastClientX:dr,lastClientY:q,startPointerAngleDeg:Bl(dr,q,wr,ir),startAngle:e,centerX:wr,centerY:ir,hasExceededThreshold:!1}},[e,kr,o]),O=(0,s.useCallback)(U=>{if(u.current!=null){L({clientX:U.clientX,clientY:U.clientY});return}const W=p.current;if(!W)return;Number.isFinite(U.clientX)&&Number.isFinite(U.clientY)?(W.lastClientX=U.clientX,W.lastClientY=U.clientY):(W.lastClientX+=U.movementX??0,W.lastClientY+=U.movementY??0);const{lastClientX:Y,lastClientY:wr}=W,ir=Math.hypot(Y-W.startClientX,wr-W.startClientY);if(!W.hasExceededThreshold){if(ir<nk)return;W.hasExceededThreshold=!0,_(!0)}rr({clientX:Y,clientY:wr,shiftKey:U.shiftKey})},[L,rr]),cr=(0,s.useCallback)(()=>{if(u.current!=null){K();return}V()},[K,V]),br=(0,s.useCallback)(()=>{if(u.current!=null){K();return}V()},[K,V]),$r=(0,s.useCallback)(()=>{u.current!=null&&K()},[K]);return(0,i.jsxs)("div",{"arc-gradient-field-wrapper":"",role:"group","aria-label":c.gradientStops,children:[(0,i.jsxs)("small",{"arc-gradient-field-angle-output":"","aria-hidden":"true",children:[I,"\xB0"]}),(0,i.jsx)("div",{ref:l,"arc-gradient-field":"","is-unset":a?"":void 0,"is-dragging":w!=null||E?"":void 0,"is-rotating":E?"":void 0,style:D,onPointerDown:er,onPointerMove:O,onPointerUp:cr,onPointerCancel:br,onLostPointerCapture:$r,children:S.map((U,W)=>(0,i.jsx)(ck,{entry:U,sortedIndex:W,angle:I,isDragging:w===U.index,stopPositionLabel:c.stopPosition,onAtChange:M,onDragStart:lr},`gradient-stop-thumb-${U.index}`))})]})},{ANGLE_MIN:sk,ANGLE_MAX:lk,ANGLE_SNAP_STEP:dk}=nr,uk=({inputProps:r,labels:e,...a})=>{const{id:t="angle-slider",min:o=sk,max:n=lk,step:c=1,value:l,onChange:u,...h}=r,p=e??pe,v=Nr(void 0,`${t}-label`),g=(0,s.useCallback)(f=>{if(f.shiftKey||!id(f.key))return;const b=sd(f.key,f,{step:Number(c)});if(b==null)return;f.preventDefault();const $=I0(Number(l),b,{min:Number(o),max:Number(n)}),x={value:String($)};u?.(x,f)},[o,n,c,l,u]);return(0,i.jsxs)("div",{"arc-gradient-angle-slider":"",children:[(0,i.jsx)(q0,{sectionName:"angle",content:p.angle,id:v}),(0,i.jsx)(ld,{"arc-angle-slider":"",...a,layout:"fill",size:"md",snapStep:dk,inputIdPrefix:t,inputProps:{...h,min:o,max:n,step:c,value:l,onChange:u,onKeyDown:g,"aria-labelledby":v},valueInputProps:{showValueInput:!0},tooltipProps:{showTooltip:!0,text:"{#value}\xB0"}})]})},hk="gradient-angle-presets",pk=(r,e)=>nr.ANGLE_PRESETS.map(a=>({stops:r,angle:a,name:e(a)})),gk=({gradient:r,onSelectAngle:e,labels:a})=>{const t=a??pe,o=r?.angle??nr.ANGLE,n=(0,s.useMemo)(()=>pk(r?.stops??nr.STOPS,t.gradientAngleOption),[r?.stops,t.gradientAngleOption]),c=(0,s.useMemo)(()=>n.find(u=>u.angle===o),[n,o]),l=u=>{np(u)&&e?.(u.gradientData.angle)};return(0,i.jsx)(Dn,{"arc-gradient-presets":"",id:hk,colors:n,activeGradient:c,showHeading:!1,setAriaLabel:t.gradientAngle,onSwatchClick:l,labels:a})},{ANGLE_MIN:rg,ANGLE_MAX:eg,ANGLE:vk}=nr,fk=({state:r,tools:e,isUnset:a=!1,onAddGradient:t,editFallbackColor:o,format:n,labels:c})=>{const{commitGradient:l,previewGradient:u,startPreview:h,endPreview:p}=r,v=r.displayGradient,g=v.angle??vk,f=(0,s.useRef)(g),[b,$]=(0,s.useState)(null),x=(0,s.useCallback)((C,S="commit")=>{const T={...v,...C};S==="preview"?u(T):l(T)},[v,u,l]),A=(0,s.useCallback)(()=>{p(),x({angle:f.current},"commit")},[p,x]),{createInputProps:y}=s0({onCommit:A}),w=(0,s.useMemo)(()=>y(C=>{const S=ar(C,rg,eg);f.current=S,$(S),h({kind:"angle-slider"}),x({angle:S},"preview")},()=>$(null)),[y,x,h]),k=(0,s.useMemo)(()=>!e||e.length===0?[...di]:[...e],[e]),E=(0,s.useMemo)(()=>{const C={gradientField:k.includes("gradient-field"),gradientStops:k.includes("gradient-stops"),angleSlider:k.includes("angle-slider"),anglePresets:k.includes("angle-presets")};return C.gradientField||C.gradientStops||C.angleSlider||C.anglePresets?C:null},[k]);if(!E)return null;const _=a||(v.stops?.length??0)===0,I=_?[]:v.stops??[];return(0,i.jsxs)("div",{"arc-color-tools":"gradient","arc-color-picker-section":"tools",children:[E.gradientField&&(0,i.jsx)(ik,{stops:I,angle:g,isUnset:_,onUpdateStops:(C,S)=>x({stops:C},S??"commit"),onUpdateAngle:(C,S)=>x({angle:C},S??"commit"),labels:c}),E.gradientStops&&(0,i.jsx)(ok,{state:r,isEmpty:_,onAddGradient:t,editFallbackColor:o,format:n,labels:c}),E.angleSlider&&(0,i.jsx)(uk,{labels:c,inputProps:{surfaceName:"angle",min:rg,max:eg,value:b??g,...w}}),E.anglePresets&&(0,i.jsx)(gk,{gradient:{stops:I,angle:g},onSelectAngle:C=>x({angle:C}),labels:c??pe})]})},ag=({heading:r,showGoBack:e,goBackProps:a,...t})=>(0,i.jsx)(ga,{...t,variant:"common","arc-color-picker-wrapper":"",showGoBack:e,goBackProps:a,headerSlot:!!r&&(0,i.jsx)(le,{...typeof r=="string"?{text:r}:r,"arc-color-picker-heading":"",overflow:"truncate",isStrong:!0})});ag.displayName="ArcColorPickerWrapper";const mk=(r,e)=>{switch(e.type){case"SET_COLOR":return{...r,hsv:e.hsv,selectedName:e.name,isUnset:!1};case"SET_UNSET":return r.isUnset?r:{...r,isUnset:!0,selectedName:void 0};case"SET_GRADIENT":return e.exitUnset&&r.isUnset?{...r,gradient:e.gradient,isUnset:!1}:{...r,gradient:e.gradient};case"SET_PANEL":return r.panel===e.panel?r:{...r,panel:e.panel};case"SET_NAME":return r.selectedName===e.name?r:{...r,selectedName:e.name};default:return r}},Vn=({color:r,name:e,gradient:a,isUnset:t=!1,format:o="auto",activePanel:n="solid"})=>{const c=mi(r)?r:_n(r).color,l=e??(mi(r)||typeof r=="string"?void 0:r.name),u=Ra(c,{format:o}),h=l?{...u,name:l}:u,p=wo(a,{fallbackColor:h.value}),v=n==="gradient"?p.value:h.value;return{activePanel:n,value:t?"":v,isUnset:t?!0:void 0,color:h,gradient:p}},bk={h:0,s:0,v:0,a:1},$k={stops:[],angle:nr.ANGLE},tg=r=>r??$k,Mi=r=>r==null?"":_n(r).color,og=(r,e)=>{const a=Zr(Mi(r));return a?pi(a,e):null},yk=({color:r,gradient:e,panel:a,format:t,syncKey:o,onChange:n,onSnapshotChange:c,onPreviewColor:l,onPreviewGradient:u})=>{const[h,p]=(0,s.useReducer)(mk,void 0,()=>({hsv:og(r)??bk,isUnset:a==="gradient"?e==null:Mi(r)==="",gradient:tg(e),panel:a})),[v,g]=(0,s.useReducer)(Xy,xi),[f,b]=(0,s.useState)(null),[$,x]=(0,s.useState)(null),A=(0,s.useRef)(v);A.current=v;const y=(0,s.useRef)(h);y.current=h;const w=(0,s.useRef)(o),k=(0,s.useRef)(Mi(r)),E=(0,s.useRef)(tg(e));ha(()=>{const P=Mi(r),F=a==="gradient"?e==null:P==="",or=o!==w.current;w.current=o;const gr=P!==k.current;k.current=P;const L=e!=null&&!$i(e,E.current);if(e!=null&&(E.current=e),!or&&!gr&&!L)return;const X=or||A.current.status==="idle";if(or&&(g({type:"EXTERNAL_ADOPT"}),b(null),x(null)),!!X){if(F&&p({type:"SET_UNSET"}),(or||gr)&&!F){const sr=og(r,y.current.hsv.h);sr&&p({type:"SET_COLOR",hsv:sr})}(or||L)&&e!=null&&p({type:"SET_GRADIENT",gradient:e,exitUnset:L})}},[r,e,o,a]);const _=(0,s.useCallback)((P,F)=>{if(!(!n&&!c))try{const or={...Ra(P,{format:t}),name:F};c&&c(Vn({color:P,name:F,gradient:y.current.gradient,format:t,activePanel:"solid"})),n?.({activePanel:"solid",color:or})}catch{}},[t,n,c]),I=(0,s.useCallback)((P,F)=>{p({type:"SET_COLOR",hsv:P,name:F}),b(null),y.current={...y.current,hsv:P,selectedName:F,isUnset:!1};try{k.current=Ra(P,{format:t}).value}catch{}_(P,F)},[_,t]),C=(0,s.useCallback)(()=>{if(p({type:"SET_UNSET"}),b(null),y.current={...y.current,isUnset:!0,selectedName:void 0},k.current="",!(!n&&!c))try{c&&c(Vn({color:y.current.hsv,gradient:y.current.gradient,isUnset:!0,format:t,activePanel:"solid"})),n?.({activePanel:"none",color:null,gradient:null})}catch{}},[t,n,c]),S=(0,s.useCallback)(P=>{if(b(P),!!l)try{l(Ra(P,{format:t}))}catch{}},[t,l]),T=(0,s.useCallback)(P=>{if(p({type:"SET_GRADIENT",gradient:P,exitUnset:!0}),x(null),y.current={...y.current,gradient:P,isUnset:!1},E.current=P,!(!n&&!c))try{const F=Pa(Ge(y.current.hsv)),or=wo(P,{fallbackColor:F});c&&c(Vn({color:y.current.hsv,gradient:P,format:t,activePanel:"gradient"})),n?.({activePanel:"gradient",gradient:or})}catch{}},[t,n,c]),D=(0,s.useCallback)(P=>{if(x(P),!!u)try{const F=Pa(Ge(y.current.hsv));u(wo(P,{fallbackColor:F}))}catch{}},[u]),N=(0,s.useCallback)(P=>g({type:"PREVIEW_START",source:P}),[]),H=(0,s.useCallback)(()=>{g({type:"PREVIEW_END"}),b(null),x(null)},[]),J=(0,s.useCallback)((P,F)=>g({type:"EDIT_FOCUS",field:P,draft:F}),[]),R=(0,s.useCallback)(P=>g({type:"EDIT_INPUT",draft:P}),[]),M=(0,s.useCallback)(()=>g({type:"EDIT_BLUR"}),[]);return{model:h,interaction:v,displayHsv:f??h.hsv,displayGradient:$??h.gradient,isUnset:h.isUnset&&f===null&&$===null,commitColor:I,commitUnset:C,commitGradient:T,previewColor:S,previewGradient:D,startPreview:N,endPreview:H,editFocus:J,editInput:R,editBlur:M}},Je={mode:"normal",color:"#05aff0",format:"auto",heading:pe.heading,palettes:[]},xk={stops:nr.STOPS,angle:nr.ANGLE},kk=["solid","gradient"],wk={icon:"fa-regular fa-paint-brush",text:pe.colorPicker,layout:"icon",shape:"round",size:"md"},Sd=(r,e)=>r.length===0||r.includes(e)?e:r[0],Ak=r=>{const e=Ge(r);return{"--js\u2022hue":`hsl(${r.h} 100% 50%)`,"--js\u2022hex":Ke({...e,a:1},!1),"--js\u2022rgb":Pa(e)}},La=({children:r,color:e,defaultColor:a,unsetColorPlacement:t="none",gradient:o,format:n=Je.format,mode:c=Je.mode,heading:l=Je.heading,tools:u,omitTools:h,isInline:p=!1,showGoBack:v=!1,goBackProps:g,canTogglePanels:f=!1,panels:b=kk,activePanel:$="solid",onUpdatePanel:x,palettes:A,popoverProps:y,expandHexShorthand:w,syncKey:k,labels:E,onChange:_,onSnapshotChange:I,onPreviewColor:C,onPreviewGradient:S,onAddColor:T,onRemoveColor:D,...N})=>{const H=(0,s.useMemo)(()=>ui(E),[E]),J=c==="simple",R=Nr(y?.id??void 0,"color-picker"),M=(0,s.useRef)(null),[P,F]=(0,s.useState)(()=>Sd(b,$)),or=e===void 0?a??null:e,L=yk({color:or,gradient:o??null,panel:P,format:n,syncKey:k,onChange:_,onSnapshotChange:I,onPreviewColor:C,onPreviewGradient:S}),X=(0,s.useRef)(void 0),sr=(0,s.useRef)(L.model.hsv);sr.current=L.model.hsv;const mr=(0,s.useCallback)(Sr=>L.commitColor(Sr,X.current),[L]),rr=(0,s.useMemo)(()=>Pa(Ge(L.model.hsv)),[L.model.hsv]),ur=(0,s.useMemo)(()=>A?.map(Sr=>({...Sr,canAddColor:!1,canRemoveColor:!1}))??[],[A]),yr=(0,s.useCallback)(Sr=>{F(Gr=>{const Fr=typeof Sr=="function"?Sr(Gr):Sr,Hr=Sd(b,Fr);return Hr!==Gr&&x?.(Hr),Hr})},[b,x]),lr=(0,s.useRef)(null),kr=(0,s.useCallback)(Sr=>{if(I)try{I(Vn({color:L.model.hsv,gradient:L.model.gradient,isUnset:L.isUnset,format:n,activePanel:Sr}))}catch{}},[I,L.model.hsv,L.model.gradient,L.isUnset,n]),V=(0,s.useRef)($);(0,s.useEffect)(()=>{V.current!==$&&(V.current=$,F(Sd(b,$)))},[$,b]),(0,s.useEffect)(()=>{const Gr=!(lr.current===null)&&lr.current!==P;lr.current=P,Gr&&kr(P)},[P,kr]);const K=(0,s.useMemo)(()=>{const Gr=P==="gradient"?di:J?op:Al,Fr=!u||u.length===0?[...Gr]:[...u];if(!h?.length)return Fr;const Hr=new Set(h);return Fr.filter(Ve=>!Hr.has(Ve))},[u,h,P,J]),er=K.includes("palettes"),O=t!=="none"&&!J,cr=O&&t==="tools"&&P==="solid",br=O&&t==="header",$r=(0,s.useMemo)(()=>Ak(L.displayHsv),[L.displayHsv]),W=P==="gradient"?"gradient":J?"simple":"solid",Y=er?A:void 0,wr=(0,s.useCallback)(()=>{const Sr=Pa(Ge(L.model.hsv)),Gr=(or!=null?_n(or).color:"")||Sr||Je.color,Fr=Np({...L.model.gradient,stops:[]},Gr);Fr.stops.length>0&&L.commitGradient(Fr)},[or,L]),ir=(0,i.jsxs)("div",{...N,ref:M,"arc-color-picker":W,"is-inline":p?"":void 0,"is-unset":L.isUnset?"":void 0,style:$r,children:[J?(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(i0,{palettes:ur.length?ur:void 0,activePaletteColor:rr,commitLocalHsv:mr,selectedNameRef:X,hsvRef:sr,popoverId:R,labels:H}),(0,i.jsx)(F0,{state:L,tools:K,isSimpleMode:!0,expandHexShorthand:w,labels:H})]}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(ek,{canTogglePanels:f,panels:b,activePanel:P,setActivePanel:yr,labels:H}),P==="gradient"?(0,i.jsx)(fk,{state:L,tools:K,isUnset:L.isUnset,onAddGradient:wr,editFallbackColor:_n(e??"").color,format:n,labels:H}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(F0,{state:L,tools:K,isUnsetColorInTools:cr,expandHexShorthand:w,labels:H}),(0,i.jsx)(i0,{palettes:Y,activePaletteColor:rr,commitLocalHsv:mr,selectedNameRef:X,hsvRef:sr,popoverId:R,onAddColor:T??vo,onRemoveColor:D,labels:H,"has-divider":"top"})]})]}),r&&(0,i.jsx)("div",{"arc-color-picker-section":"footer",children:r})]});if(p)return ir;const dr=br?(0,i.jsx)(z0,{isUnset:L.isUnset,onSelect:L.commitUnset,labels:H}):null,q=dr||y?.headerSlotEnd?(0,i.jsxs)(i.Fragment,{children:[y?.headerSlotEnd,dr]}):void 0,pr=y?.anchorProps??wk,Rr=y?.popover??(J?"":"manual"),Ir=J?{...y,anchorAt:y?.anchorAt??"bottom-center",showDismiss:!1,hasTail:!0}:{...y,heading:l??void 0,showGoBack:v??void 0,goBackProps:g??void 0,headerSlotEnd:q??void 0,showHeaderDivider:!0,showFooterDivider:!0,isHeaderSticky:!0,isFooterSticky:!0};return(0,i.jsx)(ag,{...Ir,popover:Rr,anchorProps:pr,id:R,children:ir})},Ck=({color:r,gradient:e=xk,isUnset:a,format:t=Je.format,activePanel:o="solid"}={})=>{const n=r==null||r==="";return Vn({color:n?Je.color:r,gradient:e,isUnset:a??n,format:t,activePanel:o})};La.getColorAs=Sp,La.getColorData=Ra,La.getGradientData=wo,La.getSnapshot=Ck,La.getContrastColor=ko,La.addColor=by,La.removeColor=$y,Cr("ArcColorPicker",Uy);const zd={course:"Course",scenario:"Scenario",presentation:"Enablement Deck",microlearning:"Microlearning",video:"Interactive Video",guide:"Walkthrough",package:"Kit",custom:"Icon"},Ed={course:"Multiple interactive lessons with quizzes",microlearning:"A focused lesson on a single learning objective",presentation:"Shareable slides, polished and easy to keep current",guide:"A step-by-step guide to completing a task",video:"Chaptered recording with built-in, interactive checkpoints",scenario:"Conversational practice for real situations",package:"Learning packages",custom:"Custom learning content"},_d=r=>r?{...zd,...r}:zd,Sk=r=>r?{...Ed,...r}:Ed,xa=d`--arc•icon•avatar`,ka=d`${xa}•fg`,wa=d`${xa}•bg`,Dt=d`${xa}•width`,To=d`${xa}•size`,zk=d`
  &[data-color=brand],
  &[data-color=blue] {
    ${ka}: var(--arc-color-fg-blue-mid);
    ${wa}: var(--arc-color-bg-blue-subtle);
  }
  &[data-color=purple] {
    ${ka}: var(--arc-color-fg-purple-mid);
    ${wa}: var(--arc-color-bg-purple-subtle);
  }
  &[data-color=yellow] {
    ${ka}: var(--arc-color-fg-yellow-mid);
    ${wa}: var(--arc-color-bg-yellow-subtle);
  }
  &[data-color=orange] {
    ${ka}: var(--arc-color-fg-orange-mid);
    ${wa}: var(--arc-color-bg-orange-subtle);
  }
  &[data-color=red] {
    ${ka}: var(--arc-color-fg-red-mid);
    ${wa}: var(--arc-color-bg-red-subtle);
  }
  &[data-color=green] {
    ${ka}: var(--arc-color-fg-green-mid);
    ${wa}: var(--arc-color-bg-green-subtle);
  }
  &[data-color=mint] {
    ${ka}: var(--arc-color-fg-mint-mid);
    ${wa}: var(--arc-color-bg-mint-subtle);
  }
  &[data-color=maroon] {
    ${ka}: var(--arc-color-fg-maroon-mid);
    ${wa}: var(--arc-color-bg-maroon-subtle);
  }
  &[data-color=neutral] {
    ${ka}: var(--arc-color-fg-neutral-stark);
    ${wa}: var(--arc-color-bg-neutral-subtle);
  }
  &[data-color=ai] {
    ${ka}: var(--arc-color-fg-purple-stark);
    ${wa}: var(--arc-gradient-ai-100);
  }
`,Ek=d`
  &[data-size=inherit] {
    ${Dt}: 2em;
...
`,jk=({children:r,text:e,iconAvatar:a={},subtext:t,size:o,isStrong:n,...c})=>{const l=a.variant??Io.variant,u=l==="custom"?void 0:_d(a.labels)[l],h=r??e??u;return(0,i.jsxs)("span",{...c,"arc-icon-avatar-text":"","is-strong":n?"":void 0,children:[(0,i.jsx)(ng,{...a,size:o}),(0,i.jsxs)("span",{"data-element":"text",children:[(0,i.jsx)("span",{"data-element":"title",children:h}),t!=null&&(0,i.jsx)("small",{"data-element":"subtext",children:t})]})]})};Cr("ArcIconAvatarText",Rk);const cg=({size:r="md",layout:e="icon",variant:a="common",hierarchy:t="tertiary",...o})=>(0,i.jsx)(Lr,{...o,"arc-input-action":"",size:r,layout:e,variant:a,hierarchy:t}),Ni=d`--arc•link`,Ma=d`${Ni}•fg`,Un=d`${Ma}•hover`,Gn=d`${Ma}•disabled`,Td=d`${Ni}•outline`,ig=d`${Td}•size`,Id=d`${Td}•offset`,Lk=d`${Ni}•cursor`,Kn=d`${Ni}•focus•color`,Mk=d`
@layer arc-components {
${Pf}
...
`,Dk=vr(Xr,["inherit","primary","secondary","inverse"]),Ok=({children:r,layout:e="gutter",size:a="inherit",variant:t="inherit",tag:o="a",href:n,icon:c,text:l,overflow:u,iconSize:h,gapSize:p,isFlipped:v,isDisabled:g,...f})=>(0,i.jsx)(o,{...f,href:g?void 0:n,"arc-link":"","data-variant":t,"aria-disabled":g,"data-is-disabled":g?"":void 0,children:r||(0,i.jsx)(le,{icon:c,text:l,overflow:u,iconSize:h,gapSize:p,size:a,layout:e,isFlipped:v})});Cr("ArcLink",Mk);const Nk=[...Ha],Bk=vr(Xr,["common"]),Fk=vr(Xr,["common","critical"]),Hk=vr(Xr,["common","brand","info","success","warning","error","processing"]),Vk=["auto","dark","light","none"],Uk=["auto","all","top-bottom","left-right","left-right-top","left-right-bottom","top-bottom-left","top-bottom-right","none"],Gk=vr(ve,["xl","lg","md","sm","custom","fullscreen"]),Kk=["cancel","escape","outside","button:dismiss","button:back","button:primary","button:secondary","button:tertiary","confirm:discard","confirm:cancel"],Pd=r=>r?.matches(":modal"),Rd=(r,e)=>e.target===r,Wk=(r,e)=>e.clientX<r.left||e.clientX>r.right||e.clientY<r.top||e.clientY>r.bottom,Wn=({modalRef:r,shouldConfirm:e,setIsConfirming:a,onCloseOverride:t=void 0})=>(o,n)=>c=>{if(c?.preventDefault?.(),c?.stopPropagation?.(),!r?.current){n?.(c);return}if(t){t(o,c,r.current),n?.(c);return}if(e&&o!=="confirm:discard"){a?.(!0);return}r.current?.close(o),a?.(!1),n?.(c)},jd=({modalRef:r,shouldConfirm:e,setIsConfirming:a,onClose:t,onToggle:o})=>{(0,s.useEffect)(()=>{const n=r.current;if(!n)return;const c=u=>{Pd(n)&&Rd(n,u)&&(e?(u.preventDefault(),u.stopPropagation(),a?.(!0)):t?.("outside",u))},l=u=>{Rd(n,u)&&(a?.(!1),t?.(n.returnValue,u),o?.(!1,u))};return n.addEventListener("close",l),n.addEventListener("cancel",c),()=>{n.removeEventListener("close",l),n.removeEventListener("cancel",c)}},[r,e,a,t,o])},Ld=({modalRef:r,isOpen:e,isTopLayer:a})=>{(0,s.useEffect)(()=>{const t=r.current;t&&(e&&!t.open&&(a?t.showModal():t.show()),!e&&t.open&&t.close())},[e,a])},Md=({modalRef:r,isOpen:e,autoFocusId:a})=>{(0,s.useEffect)(()=>{const t=r.current;if(!t||!a||!e)return;const o=t.querySelector(`#${a}`);if(!o||!(o instanceof HTMLElement))return;const n=setTimeout(()=>{o.focus()},0);return()=>clearTimeout(n)},[r,a,e])},sg=(r,e)=>(typeof r.composedPath=="function"?r.composedPath():[]).includes(e)||r.target instanceof Node&&e.contains(r.target),lg=({modalRef:r,isOpen:e=!1,closeOnBackdrop:a=!1,attemptCloseModal:t})=>{(0,s.useEffect)(()=>{const o=r.current;if(!o||!e||!a||!Pd(o))return;let n=!1;const c=u=>{n=sg(u,o)},l=u=>{if(n||sg(u,o))return;const h=o.getBoundingClientRect();Wk(h,u)&&t("outside")(u)};return document.documentElement?.addEventListener("pointerdown",c,{capture:!0}),document.documentElement?.addEventListener("click",l,{capture:!0}),()=>{document.documentElement?.removeEventListener("pointerdown",c,{capture:!0}),document.documentElement?.removeEventListener("click",l,{capture:!0})}},[r,t,e,a])},dg=({modalRef:r,isOpen:e=!1,closeOnEsc:a=!1,closedBy:t="closerequest",attemptCloseModal:o})=>{(0,s.useEffect)(()=>{const n=r.current;if(!n||!e||!a||!Pd(n))return;const c=l=>{if(l.key==="Escape"&&Rd(n,l)){if(t==="none"){l.stopPropagation(),l.preventDefault();return}o("escape")(l)}};return document.addEventListener("keydown",c),()=>document.removeEventListener("keydown",c)},[r,o,e,a,t])},Dd=r=>(0,i.jsx)(Lr,{"aria-label":"Dismiss",text:"Dismiss",...r,variant:"common",hierarchy:"tertiary",icon:"fa-regular fa-xmark-large",layout:"icon",shape:"square",size:"md"}),Xk=r=>(0,i.jsx)(Lr,{"arc-modal-go-back":"","aria-label":"Go Back",text:"Go Back",...r,variant:"common",hierarchy:"secondary",icon:"fa-regular fa-arrow-left",layout:"icon",shape:"square",size:"md"}),Bi=(0,s.forwardRef)(({inert:r,...e},a)=>(0,i.jsx)("div",{...e,ref:a,"arc-modal-content":"",inert:r}));Bi.displayName="ModalContent";const ug=({showDivider:r,...e})=>(0,i.jsx)("header",{...e,"arc-modal-header":"","has-divider":r?"":void 0}),qk=({glyph:r,variant:e="common"})=>(0,i.jsx)(i.Fragment,{children:r&&(0,i.jsx)(zr,{icon:r,"arc-modal-glyph":"","arc-icon-status":e})}),Od=r=>{const{titleContent:e,TitleElement:a="h2",...t}=r;return(0,i.jsx)(i.Fragment,{children:e&&(0,i.jsx)(a,{...t,"arc-modal-title":"",children:typeof e=="string"?e:(0,i.jsx)(le,{...e})})})},Yk=({message:r,...e})=>(0,i.jsx)(i.Fragment,{children:r&&(0,i.jsx)("p",{...e,"arc-modal-message":"",children:r})}),Nd=({tag:r="section",padding:e,...a})=>(0,i.jsx)(r,{...a,"arc-modal-body":"","data-padding":e==="auto"?void 0:e}),Bd=({showDivider:r,...e})=>(0,i.jsx)("footer",{...e,"arc-modal-footer":"","has-divider":r?"":void 0}),Zk=r=>e=>{if(e.key==="Escape"){if(r==="none"){e.stopPropagation(),e.preventDefault();return}return"escape"}},xr=d`--arc•modal`,Xn=d`${xr}•layout`,Jk=d`${xr}•header`,Fi=d`${xr}•body`,qn=d`${xr}•footer`,hg=d`${xr}•fg`,Hi=d`${xr}•bg`,Da=d`${xr}•backdrop`,vt=d`${xr}•scale`,Po=d`${Jk}•padding`,Qr=d`${Fi}•padding`,ft=d`${qn}•padding`,Qk=d`
...
@layer arc-components {
  ...
  ${tw}
  ${ow}
`,mt={variant:"common",backdropColor:"auto",message:"You have unsaved changes. Discard them?",onCloseOverride:void 0,isTopLayer:!0,isInverse:!1,scheme:"auto"},pg=({children:r,headerProps:e,bodyProps:a,footerProps:t,...o})=>{const n=(0,s.useRef)(null),{isOpen:c,autoFocusId:l,isTopLayer:u=mt.isTopLayer,isInverse:h=mt.isInverse,scheme:p=mt.scheme,backdropColor:v=mt.backdropColor,variant:g=mt.variant,message:f=mt.message,onCloseOverride:b=mt.onCloseOverride,onConfirmDiscard:$,onConfirmCancel:x,contentRef:A,...y}=o,{slotStart:w,TitleElement:k,titleContent:E,slotEnd:_,...I}=e||{},{primaryButton:C,secondaryButton:S,...T}=t||{},D=!!(E||w||_),N=p==="auto"?void 0:p,H=!!b,J=F=>H?b?.("confirm:discard",F,n.current??void 0):$?.("confirm:discard",F),R=F=>H?b?.("confirm:cancel",F,n.current??void 0):x?.("confirm:cancel",F);jd({modalRef:n,onClose:b}),Ld({modalRef:n,isOpen:c,isTopLayer:u}),Md({modalRef:n,isOpen:c,autoFocusId:l});const M=F=>{R(F),S?.onClick?.(F)},P=F=>{J(F),C?.onClick?.(F)};return(0,i.jsx)("dialog",{...y,ref:n,"arc-modal":"","arc-scheme":h?"inverse":N,"is-confirm":g||"","is-inverse":h?"":void 0,"is-top-layer":u?"":void 0,"is-backdrop":v==="auto"?void 0:v,"data-size":"sm",closedby:"none",onKeyDown:Zk("none"),children:(0,i.jsxs)(Bi,{ref:A,children:[D&&(0,i.jsxs)(ug,{...I,children:[w&&(0,i.jsx)("div",{"header-slot":"start",children:w}),(0,i.jsx)("div",{"header-slot":"content",children:(0,i.jsx)(Od,{TitleElement:k,titleContent:E})}),_&&(0,i.jsx)("div",{"header-slot":"end",children:_})]}),(0,i.jsx)(Nd,{...a,children:r||f&&(0,i.jsx)("p",{style:{margin:0},children:f})}),(0,i.jsx)(Bd,{...T,children:(0,i.jsxs)(jt,{children:[(0,i.jsx)(Lr,{...S,text:S?.text||"Cancel",variant:"common",hierarchy:"secondary",isInverse:h,onClick:M}),(0,i.jsx)(Lr,{...C,text:C?.text||"Discard",variant:g??"common",hierarchy:"primary",isInverse:h,onClick:P})]})})]})})};Cr("ArcModalConfirm",Fd);const He={size:"md",variant:"common",backdropColor:"auto",isTopLayer:!0,isInverse:!1,scheme:"auto",showDismiss:!0,closeOnEsc:!0,closeOnBackdrop:!1,hasConfirmFlow:!1,hasUnsavedChanges:!1,onCloseOverride:void 0,bypassConfirmWhen:{didPressEscapeKey:!1,didClickBackdrop:!1,didClickGoBackButton:!1,didClickDismissButton:!1,didClickPrimaryButton:!1,didClickSecondaryButton:!1,didClickTertiaryButton:!1},headerProps:{showDivider:!1},bodyProps:{padding:"auto"},footerProps:{showDivider:!1}},nw=({children:r,confirmProps:e,headerProps:a,bodyProps:t,dismissProps:o,footerProps:n,...c})=>{const l=(0,s.useRef)(null),[u,h]=(0,s.useState)(!1),{isOpen:p,autoFocusId:v,isTopLayer:g=He.isTopLayer,isInverse:f=He.isInverse,scheme:b=He.scheme,backdropColor:$=He.backdropColor,hasConfirmFlow:x=He.hasConfirmFlow,hasUnsavedChanges:A=He.hasUnsavedChanges,onCloseOverride:y=He.onCloseOverride,bypassConfirmWhen:w=He.bypassConfirmWhen??{},size:k=He.size,closeOnBackdrop:E=He.closeOnBackdrop,closeOnEsc:_=He.closeOnEsc,showDismiss:I=He.showDismiss,onActionError:C,onClose:S,onToggle:T,width:D,height:N,style:H,contentRef:J,...R}=c,{showGoBack:M,goBackProps:P,slotStart:F,TitleElement:or,titleContent:gr,slotEnd:L,showDivider:X=He.headerProps?.showDivider,...sr}=a??{},{slotStart:mr,primaryButton:rr,secondaryButton:ur,tertiaryButton:yr,showDivider:lr=He.footerProps?.showDivider,...kr}=n??{},V=!!(M||gr||F||L),K=!!(rr||ur||yr),er=!!(K||mr),O=!!(x&&A),cr=_?"closerequest":"none",br=b==="auto"?void 0:b,{didPressEscapeKey:$r,didClickBackdrop:U,didClickGoBackButton:W,didClickDismissButton:Y,didClickPrimaryButton:wr,didClickSecondaryButton:ir,didClickTertiaryButton:dr}=w,q=Wn({modalRef:l,shouldConfirm:O,setIsConfirming:h,onCloseOverride:y});jd({modalRef:l,shouldConfirm:O,setIsConfirming:h,onClose:S,onToggle:T}),Ld({modalRef:l,isOpen:p,isTopLayer:g}),Md({modalRef:l,isOpen:p,autoFocusId:v}),lg({modalRef:l,isOpen:p,closeOnBackdrop:E,attemptCloseModal:U?Wn({modalRef:l,shouldConfirm:O&&!U,setIsConfirming:h}):q}),dg({modalRef:l,isOpen:p,closeOnEsc:_,closedBy:cr,attemptCloseModal:$r?Wn({modalRef:l,shouldConfirm:O&&!$r,setIsConfirming:h}):q});const pr=()=>h(!1),Rr=(Sr,Gr)=>q(Sr)(Gr),Ir=(Sr,Gr,Fr)=>async Hr=>{Hr?.preventDefault?.(),Hr?.stopPropagation?.();const Ve=()=>Gr?Wn({modalRef:l,shouldConfirm:O&&!Gr,setIsConfirming:h})(Sr,Fr?.onCloseCallback)(Hr):q(Sr,Fr?.onCloseCallback)(Hr);try{await Fr?.onClick?.(Hr),Ve()}catch(ee){C?.(ee,{reason:Sr,event:Hr})}};return(0,i.jsxs)("dialog",{...R,ref:l,"arc-modal":"","arc-scheme":f?"inverse":br,"is-inverse":f?"":void 0,"is-top-layer":g?"":void 0,"is-backdrop":$==="auto"?void 0:$,"data-size":k,closedby:cr,style:{"--arc-modal-width":D??"","--arc-modal-height":N??"",...H},children:[!V&&I&&(0,i.jsx)("div",{"arc-modal-dismiss":"",children:(0,i.jsx)(Dd,{...o,isInverse:f,onClick:Ir("button:dismiss",Y,o)})}),(0,i.jsxs)(Bi,{ref:J,inert:u?"":void 0,children:[V&&(0,i.jsxs)(ug,{...sr,showDivider:X,children:[M&&(0,i.jsx)("div",{"header-slot":"go-back",children:(0,i.jsx)(Xk,{...P,isInverse:f,onClick:Ir("button:back",W,P)})}),F&&(0,i.jsx)("div",{"header-slot":"start",children:F}),(0,i.jsx)("div",{"header-slot":"content",children:(0,i.jsx)(Od,{TitleElement:or,titleContent:gr})}),L&&(0,i.jsx)("div",{"header-slot":"end",children:L}),I&&(0,i.jsx)("div",{"header-slot":"dismiss",children:(0,i.jsx)(Dd,{...o,isInverse:f,onClick:Ir("button:dismiss",Y,o)})})]}),(0,i.jsx)(Nd,{...t,children:r}),er&&(0,i.jsxs)(Bd,{...kr,showDivider:lr,children:[mr&&(0,i.jsx)("div",{"footer-slot":"content",children:mr}),K&&(0,i.jsxs)(jt,{children:[yr&&(0,i.jsx)(Lr,{...yr,text:yr?.text||"Button",isInverse:f,variant:"common",hierarchy:"tertiary",onClick:Ir("button:tertiary",dr,yr)}),ur&&(0,i.jsx)(Lr,{...ur,text:ur?.text||"Cancel",isInverse:f,variant:"common",hierarchy:"secondary",onClick:Ir("button:secondary",ir,ur)}),rr&&(0,i.jsx)(Lr,{...rr,text:rr?.text||"Action",isInverse:f,variant:"common",hierarchy:"primary",onClick:Ir("button:primary",wr,rr)})]})]})]}),x&&(0,i.jsx)(pg,{isOpen:u,isInverse:f,isTopLayer:g,backdropColor:$,...e,onConfirmDiscard:Rr,onConfirmCancel:pr})]})};Cr("ArcModal",Fd);const Qa={variant:"common",backdropColor:"auto",showDismiss:!0,closeOnBackdrop:!1,closeOnEsc:!0,onCloseOverride:void 0,isTopLayer:!0,isInverse:!1,scheme:"auto"},cw={common:"fa-solid fa-cat-space",brand:"fa-kit fa-articulate",success:"fa-solid fa-badge-check",warning:"fa-solid fa-triangle-exclamation",error:"fa-solid fa-do-not-enter",info:"fa-solid fa-circle-info",processing:(0,i.jsx)(Ac,{"arc-modal-spinner":""})},iw=({children:r,dismissProps:e,bodyProps:a,footerProps:t,...o})=>{const n=(0,s.useRef)(null),{isOpen:c,autoFocusId:l,isTopLayer:u=Qa.isTopLayer,isInverse:h=Qa.isInverse,scheme:p=Qa.scheme,backdropColor:v=Qa.backdropColor,closeOnBackdrop:g=Qa.closeOnBackdrop,closeOnEsc:f=Qa.closeOnEsc,variant:b=Qa.variant,icon:$,TitleElement:x,titleContent:A,message:y,showDismiss:w,onCloseOverride:k=Qa.onCloseOverride,onClose:E,onToggle:_,contentRef:I,...C}=o,{primaryButton:S,secondaryButton:T,...D}=t??{},N=$||cw[b],H=f?"closerequest":"none",J=p==="auto"?void 0:p,R=Wn({modalRef:n,onCloseOverride:k});return jd({modalRef:n,onClose:E,onToggle:_}),Ld({modalRef:n,isOpen:c,isTopLayer:u}),Md({modalRef:n,isOpen:c,autoFocusId:l}),lg({modalRef:n,isOpen:c,closeOnBackdrop:g,attemptCloseModal:R}),dg({modalRef:n,isOpen:c,closeOnEsc:f,closedBy:H,attemptCloseModal:R}),(0,i.jsxs)("dialog",{...C,ref:n,"arc-modal":"","arc-scheme":h?"inverse":J,"is-alert":b||"","is-inverse":h?"":void 0,"is-top-layer":u?"":void 0,"is-backdrop":v==="auto"?void 0:v,"data-size":"sm",closedby:H,children:[w&&(0,i.jsx)("div",{"arc-modal-dismiss":"",children:(0,i.jsx)(Dd,{...e,isInverse:h,onClick:R("button:dismiss",e?.onClick)})}),(0,i.jsxs)(Bi,{ref:I,children:[(0,i.jsx)(Nd,{...a,children:r||(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(qk,{glyph:N,variant:b}),(0,i.jsx)(Od,{TitleElement:x,titleContent:A}),(0,i.jsx)(Yk,{message:y})]})}),(0,i.jsx)(Bd,{...D,children:(0,i.jsxs)(jt,{children:[T&&(0,i.jsx)(Lr,{...T,text:T.text||"Cancel",variant:"common",hierarchy:"secondary",isInverse:h,onClick:R("button:secondary",T.onClick)}),(0,i.jsx)(Lr,{...S,text:S?.text||"Close",variant:"common",hierarchy:"primary",isInverse:h,onClick:R("button:primary",S?.onClick)})]})})]})]})};Cr("ArcModalAlert",Fd);const sw=d`--arc•nav`,re=d`${sw}•item`,lw=d`
@layer arc-components {
...
`,qg=({id:r,children:e,icon:a,heading:t,subtext:o,dismissProps:n,showDismiss:c=!0,onClose:l,actionSlot:u,size:h="md",variant:p="common",scheme:v=Vg.scheme,placement:g="bottom-left",getToastId:f,progressBarProps:b,severity:$,...x})=>{const A=()=>{l?.()},y=v==="auto"?void 0:v,w=!!u||c,k=Nr(r,"arc-toast"),{variant:E,hierarchy:_,...I}=n||{};(0,s.useEffect)(()=>{f?.(k)},[f,k]);const C=gs(a);return(0,i.jsx)("div",{...x,"arc-toast":"","arc-scheme":y,"data-size":h,"data-variant":p,"data-placement":g,"data-severity":$||void 0,id:k,children:(0,i.jsxs)("div",{"arc-toast-content-grid":"",children:[(0,i.jsxs)("div",{"arc-toast-body":"",children:[a&&(0,i.jsx)(zr,{icon:C,"arc-toast-icon":""}),(0,i.jsx)("div",{"arc-toast-content":"",children:e||(0,i.jsxs)(i.Fragment,{children:[t&&(0,i.jsx)("header",{"arc-toast-heading":"",children:(0,i.jsx)("strong",{children:t})}),o&&(0,i.jsx)("p",{"arc-toast-subtext":"",children:o})]})})]}),w&&(0,i.jsxs)("div",{"arc-toast-actions":"",children:[u,c&&(0,i.jsx)(Lr,{icon:"fa-regular fa-xmark-large",layout:"icon",variant:"common",hierarchy:"tertiary",size:"md",shape:"square","aria-label":"Dismiss",...I,popoverTarget:k,onClick:A})]}),b&&(0,i.jsx)(m2,{...b,variant:$==="error"?"critical":b.variant,"arc-toast-progress-bar":""})]})})};qg.handleToast=Ug,Cr("ArcToast",b2);var tc;(function(r){r.None="none",r.Persistent="localStorage",r.Temporary="sessionStorage"})(tc||(tc={}));const $2=(r,e,a)=>{const[t,o]=(0,s.useState)(e),[n,c]=Cw(r,e),[l,u]=Vd(r,e);return a===tc.Temporary?[n,c]:a===tc.Persistent?[l,u]:[t,o]},y2=["auto","hex","hexa","rgb","hsl","oklch"],x2=()=>typeof DOMRect<"u"?new DOMRect:{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0,toJSON:()=>({x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}}}]);
